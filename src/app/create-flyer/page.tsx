  ...
  return (
    <main className="create-flyer-page">
      ...
      <div className="create-flyer-note">
        ...
        <p className="create-flyer-subtitle text-center">
          Share your event, job, or opportunity with UH Mānoa
        </p>
        ...
        {hasErrors && (
          <Alert variant="danger" className="mb-3">
            Missing information. Please fill out all required fields before posting your flyer.
          </Alert>
        )}
          ...
          <Row>
            <Col xs={12}>
              <Form.Group className="mb-3">
                <Form.Label className="create-flyer-label">
                  Title<RequiredStar />
                </Form.Label>
                <Form.Control
                  name="title"
                ...
                />
                {errors.title && (
                  <Alert variant="danger" className="mt-1 py-1 px-2 small">
                    {errors.title}
                  </Alert>
                )}
              </Form.Group>
